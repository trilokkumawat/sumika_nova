;!function(){try { var e="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof global?global:"undefined"!=typeof window?window:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&((e._debugIds|| (e._debugIds={}))[n]="6bb63d62-5a8e-e3ae-d8cf-a3821601b507")}catch(e){}}();
(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,271332,e=>{"use strict";var t=e.i(478902),s=e.i(389959),r=e.i(843778),a=e.i(837710),o=e.i(253214);let i=(0,s.forwardRef)(({children:e,customFooter:i,description:n,hideFooter:l=!1,alignFooter:u="left",layout:c="horizontal",loading:d=!1,cancelText:m="Cancel",onConfirm:g=()=>{},onCancel:p=()=>{},confirmText:h="Confirm",showCloseButton:f=!0,footerBackground:_,variant:y="success",visible:b=!1,size:S="large",style:v,overlayStyle:E,contentStyle:T,triggerElement:w,header:I,modal:N,defaultOpen:O,...R},k)=>{let[P,$]=s.default.useState(!!b&&b);(0,s.useEffect)(()=>{$(b)},[b]);let A=i||(0,t.jsxs)("div",{className:"flex w-full space-x-2",style:{width:"100%",justifyContent:"vertical"===c?"center":"right"===u?"flex-end":"flex-start"},children:[(0,t.jsx)(a.Button,{type:"default",onClick:p,disabled:d,children:m}),(0,t.jsx)(a.Button,{onClick:g,disabled:d,loading:d,type:"danger"===y?"danger":"warning"===y?"warning":"primary",children:h})]});return(0,t.jsxs)(o.Dialog,{open:P,defaultOpen:O,onOpenChange:function(e){void 0===b||e?$(e):p()},modal:N,children:[w&&(0,t.jsx)(o.DialogTrigger,{children:w}),(0,t.jsxs)(o.DialogContent,{ref:k,hideClose:!f,...R,size:S,children:[I||n?(0,t.jsxs)(o.DialogHeader,{className:(0,r.cn)("border-b"),padding:"small",children:[I&&(0,t.jsx)(o.DialogTitle,{children:I}),n&&(0,t.jsx)(o.DialogDescription,{children:n})]}):null,e,!l&&(0,t.jsx)(o.DialogFooter,{padding:"small",children:A})]})]})}),n=(0,s.forwardRef)(({...e},s)=>(0,t.jsx)(o.DialogSection,{ref:s,...e,padding:"small",className:(0,r.cn)(e.className)})),l=(0,s.forwardRef)(({...e},s)=>(0,t.jsx)(o.DialogSectionSeparator,{ref:s,...e}));i.Content=n,i.Separator=l,e.s(["default",0,i])},40892,e=>{"use strict";var t=e.i(271332);e.s(["Modal",()=>t.default])},441345,e=>{"use strict";var t=e.i(343563);e.s(["Form",()=>t.default])},223600,e=>{"use strict";var t=e.i(478902),s=e.i(370410),r=e.i(816467),a=e.i(389959),o=e.i(837710),i=e.i(843778),n=e.i(375761);let l=(0,a.forwardRef)(({text:e,asyncText:l,iconOnly:u=!1,children:c,onClick:d,copyLabel:m="Copy",copiedLabel:g="Copied",...p},h)=>{let[f,_]=(0,a.useState)(!1);return(0,a.useEffect)(()=>{if(!f)return;let e=setTimeout(()=>_(!1),2e3);return()=>clearTimeout(e)},[f]),(0,t.jsx)(o.Button,{ref:h,onClick:t=>{let s=l?l():e;_(!0),(0,n.copyToClipboard)(s),d?.(t)},...p,className:(0,i.cn)({"px-1":u},p.className),icon:f?(0,t.jsx)(s.Check,{strokeWidth:2,className:"text-brand"}):p.icon??(0,t.jsx)(r.Copy,{}),children:!u&&(0,t.jsx)(t.Fragment,{children:c??(f?g:m)})})});l.displayName="CopyButton",e.s(["default",0,l])},520124,e=>{"use strict";var t=e.i(460988),s=e.i(389959);e.s(["useFillTimeseriesSorted",0,e=>{let{data:r,timestampKey:a,valueKey:o,defaultValue:i,startDate:n,endDate:l,minPointsToFill:u=20,interval:c}=e;return(0,s.useMemo)(()=>{var e;if(!r[0]?.[a])return{data:r,error:null,isError:!1};try{return{data:(e=(0,t.fillTimeseries)(r,a,o,i,n,l,u,c),[...e].sort((e,t)=>new Date(e[a]).getTime()-new Date(t[a]).getTime())),error:null,isError:!1}}catch(e){return{data:[],error:e instanceof Error?e:Error(String(e)),isError:!0}}},[JSON.stringify(r),a,JSON.stringify(o),i,n,l,u,c])}])},460988,e=>{"use strict";var t=e.i(156054),s=e.i(55956),r=e.i(784820),a=e.i(605031),o=e.i(389959);e.i(128328);var i=e.i(86086),n=e.i(884892),l=e.i(857054),u=e.i(993394);let c=e=>s.default.utc(Number(e)/1e3).toISOString(),d=e=>{let t=16===String(e).length;return!Number.isNaN(Number(e))&&t},m=(e,t)=>Object.keys(e).filter(t=>e[t]).flatMap(s=>{let r=t?`${t}.${s}`:s;return"object"==typeof e[s]?m(e[s],r):[r]}),g=(e,t)=>{let s=Object.keys(t),a=u.SQL_FILTER_TEMPLATES[e],o=e=>{let s=a[e],o=(0,r.default)(t,e);if(void 0!==o&&"function"==typeof s)return s(o);if(void 0===s)if("string"==typeof o)return`${e} = '${o}'`;else return`${e} = ${o}`;return void 0===o&&"function"==typeof s?null:s&&!1===o?null:s},i=s.map(e=>{if(void 0===t[e]||"string"==typeof t[e]&&0===t[e].length)return null;if("object"==typeof t[e]){let s=m(t[e],e).map(o).filter(Boolean);return s.length>0?`(${s.join(" or ")})`:null}{let t=o(e);return null===t?null:`(${t})`}}).filter(Boolean).join(" and ");return i?"where "+i:""},p=e=>{switch(e){case"edge_logs":return`cross join unnest(metadata) as m
